...
# {"error": "You exceeded the public API request rate (4 requests of any nature per minute)", "response_code": 204}
...
if __name__ == "__main__":
    EICAR = r"X5O!P%@AP[4\PZX54(P^)7CC)7}$EICAR-STANDARD-ANTIVIRUS-TEST-FILE!$H+H*".encode('utf-8')
