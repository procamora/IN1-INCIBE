...
def set_ip_info(ip) -> Union[Dict[str, Any], None]:
    """
    Metodo que obtiene de la base de datos toda la informacion geografica de la ip

    :return:
    """
    geoip2_db = geoip2.database.Reader('../GeoLite2-City.mmdb')

    try:
        response = geoip2_db.city(ip)
...
if __name__ == "__main__":
    ...
    print(set_ip_info('151.217.178.88'))
